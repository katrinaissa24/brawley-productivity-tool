...
export function CommandPalette() {
  ...
  const items = useMemo((): Item[] => {
    ...
    const actions: Omit<Item, "score">[] = [
      ...
      { id: "a:home", kind: "action", title: "Go to Home", icon: <IconHome size={14} />, run: () => (close(), ui.go({ name: "home" })) },
      ...
      { id: "a:goals", kind: "action", title: "Go to Goals", icon: <IconTarget size={14} />, run: () => (close(), ui.go({ name: "goals" })) },
