...
export const IconHistory = (p: P) =>
  base(
    ...
    <>
      ...
      <path d="M3.5 13a9 9 0 1 0 2.2-7.1L3 8" />
...
export const IconRefresh = (p: P) =>
  base(
    ...
    <>
      ...
      <path d="M20 10a8 8 0 1 0-1.9 6.3" />
    </>,
  );
...
export const IconBold = (p: P) =>
  base(
    p,
    <path d="M7 5h6.5a3.5 3.5 0 0 1 0 7H7zm0 7h7.5a3.5 3.5 0 0 1 0 7H7z" strokeWidth={2} />,
  );
...
export const IconTodo = (p: P) =>
  base(
    p,
    <>
      <rect x="3" y="4.5" width="7" height="7" rx="1.6" />
      <polyline points="4.5 17.5 6.5 19.5 10 15.5" />
      <line x1="13.5" y1="8" x2="20.5" y2="8" />
